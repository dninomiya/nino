...
| width | string \| number | プレビュー領域の横幅。デフォルト: "100%" |
| aspectRatio | number | 画像のアスペクト比。デフォルト: 1 |
...
<ImageCropperFileSelector aspectRatio={1} />

// 横長（16:9）- サムネイル、カバー画像
<ImageCropperFileSelector aspectRatio={16/9} />

// 縦長（3:4）- ポートレート
<ImageCropperFileSelector aspectRatio={3/4} />
